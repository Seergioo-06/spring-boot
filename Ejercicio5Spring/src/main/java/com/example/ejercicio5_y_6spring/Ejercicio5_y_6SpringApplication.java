 ...
 */
@SpringBootApplication(scanBasePackages = "com.example.ejercicio5_y_6spring")
public class Ejercicio5_y_6SpringApplication {

    public static void main(String[] args) {
        SpringApplication.run(Ejercicio5_y_6SpringApplication.class, args);
